 ...
 * @internal
 */
final class OpeningHoursStructuredDataTest extends TestCase
{
    #[Test()]
    public function it_can_render_opening_hours_as_an_array_of_structured_data(): void
    {
    ...
    #[Test()]
    public function it_can_find_previous_close_time_with_custom_timezone(): void
    {
        $schedule = [
            'monday' => ['10:00-23:59'],
            'tuesday' => ['10:00-23:59'],
